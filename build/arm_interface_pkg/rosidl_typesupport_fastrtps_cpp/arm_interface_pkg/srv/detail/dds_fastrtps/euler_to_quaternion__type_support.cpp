...
#include "arm_interface_pkg/srv/detail/euler_to_quaternion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const arm_interface_pkg::srv::EulerToQuaternion_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_interface_pkg::srv::EulerToQuaternion_Request & ros_message)
{
  // Member: roll
  cdr >> ros_message.roll;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_interface_pkg::srv::EulerToQuaternion_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_interface_pkg::srv::EulerToQuaternion_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_interface_pkg::srv::EulerToQuaternion_Request *>(
    untyped_ros_message);
...
{
  return &arm_interface_pkg::srv::typesupport_fastrtps_cpp::_EulerToQuaternion_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_interface_pkg, srv, EulerToQuaternion_Request)() {
  return &arm_interface_pkg::srv::typesupport_fastrtps_cpp::_EulerToQuaternion_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_arm_interface_pkg
cdr_serialize(
  const arm_interface_pkg::srv::EulerToQuaternion_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: x
  cdr << ros_message.x;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_interface_pkg::srv::EulerToQuaternion_Response & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arm_interface_pkg::srv::EulerToQuaternion_Response;
    is_plain =
      (
      offsetof(DataType, w) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const arm_interface_pkg::srv::EulerToQuaternion_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<arm_interface_pkg::srv::EulerToQuaternion_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &arm_interface_pkg::srv::typesupport_fastrtps_cpp::_EulerToQuaternion_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_interface_pkg, srv, EulerToQuaternion_Response)() {
  return &arm_interface_pkg::srv::typesupport_fastrtps_cpp::_EulerToQuaternion_Response__handle;
}
...
{
  return &arm_interface_pkg::srv::typesupport_fastrtps_cpp::_EulerToQuaternion__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_interface_pkg, srv, EulerToQuaternion)() {
  return &arm_interface_pkg::srv::typesupport_fastrtps_cpp::_EulerToQuaternion__handle;
}
